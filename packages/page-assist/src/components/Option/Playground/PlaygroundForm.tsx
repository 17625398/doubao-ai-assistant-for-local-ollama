...
import { Checkbox, Dropdown, Switch, Tooltip, Select, Popover, Modal } from "antd"
...
import { OpenCLIForm } from "./OpenCLIForm"
type Props = {
...
export const PlaygroundForm = ({ dropedFile }: Props) => {
  ...
  const [openCliModalVisible, setOpenCliModalVisible] = React.useState<boolean>(false)
  ...
  return (
    <div className="flex w-full flex-col items-center px-2">
                  ...
                  <div className="w-full  flex flex-col dark:border-[#404040]  px-2 ">
                    ...
                    <div className="mt-2 flex justify-between items-center">
                      ...
                      <div
                        ...
                        <KnowledgeSelect />
                        <Tooltip title={t("opencli.title")}>
                          <button
                            type="button"
                            onClick={() => setOpenCliModalVisible(true)}
                            className="flex items-center justify-center dark:text-gray-300"
                          >
      ...
      {/* OpenCLI Modal */}
      <Modal
        title={t("opencli.title")}
        open={openCliModalVisible}
        onCancel={() => setOpenCliModalVisible(false)}
        footer={null}
        width={800}
      >
        <OpenCLIForm onClose={() => setOpenCliModalVisible(false)} />
      </Modal>
    </div>
  )
}
