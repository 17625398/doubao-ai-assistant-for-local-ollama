...
import { useResponsiveValue } from '@/hooks/core/useDevice'
  ...
  return (
    <div className="flex flex-col items-center justify-center py-6 px-4 space-y-8 text-center h-full animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="max-w-lg space-y-6 flex flex-col items-center">
        <h3 className="text-3xl font-bold text-[var(--theme-text-primary)] tracking-tight">
          {t('about_title')}
        </h3>
        ...
        >
          ...
          <span className="relative flex items-center gap-3 px-5 py-2 transition-all ease-in duration-75 bg-[var(--theme-bg-primary)] rounded-full group-hover:bg-opacity-[0.96]">
            ...
            <ExternalLink
              size={12}
              className="text-[var(--theme-text-tertiary)] group-hover:text-[var(--theme-text-primary)] transition-colors opacity-0 group-hover:opacity-100 -ml-1"
            />
          </span>
        </a>
      ...
      <div className="flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto">
        ...
        {stars !== null && (
          ...
          >
            <Star
              size={iconSize}
              className="text-yellow-500 fill-yellow-500 group-hover:scale-110 transition-transform duration-300"
            />
