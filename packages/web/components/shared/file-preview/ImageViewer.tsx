...
import { ZoomIn, ZoomOut, RotateCw, Download, Maximize2, Minimize2, Home } from 'lucide-react';
...
const ImageViewerContent: React.FC<ImageViewerProps> = ({ file }) => {
    ...
    const handleDownload = useCallback(() => {
        ...
        triggerDownload(file.dataUrl, file.name || 'image', false);
    ...
    }, [handleReset, handleRotate, handleToggleFullscreen]);
        ...
        >
            ...
            <div className="absolute bottom-6 left-1/2 -translate-x-1/2 z-50 pointer-events-auto">
                <FloatingToolbar className="p-1.5">
                    ...
                    <ToolbarButton onClick={handleReset} title="Reset View (0)">
                    ...
                    <ToolbarButton onClick={handleToggleFullscreen} title={isFullscreen ? "Exit Fullscreen (F)" : "Fullscreen (F)"}>
