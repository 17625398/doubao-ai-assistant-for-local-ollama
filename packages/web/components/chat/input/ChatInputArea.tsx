      ...
      <div className={innerContainerClass}>
        ...
        <form onSubmit={formProps.onSubmit} className={formClass}>
          <SlashCommandMenu
            ...
            className={
              isFullscreen
                ? 'absolute bottom-[60px] left-0 right-0 mb-2 w-full max-w-6xl mx-auto z-20'
                : undefined
            }
          />
        ...
        {!isFullscreen && (
          <div className="mt-2 flex justify-center">
            <div className="rounded-xl border border-[var(--theme-border-secondary)] bg-[var(--theme-bg-input)] shadow-sm overflow-hidden">
              <QuickToolbar onAction={(action) => actionsProps.onAttachmentAction(action as any)} />
            </div>
          </div>
        )}
      </div>
