...
// Run non-blocking tasks in parallel to reduce startup time
const startupTasks = [
  // User setup tasks
...
// Wait for critical startup tasks to complete
await Promise.all(startupTasks);

// Discover CLIs and plugins (sequential, as plugins may override built-ins)
