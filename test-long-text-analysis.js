// Test script for long text analysis and web content extraction services

const { TextChunkingService, TextSummaryService, StructuredInformationExtractionService, WebContentExtractionService } = require('./packages/core/src/index');
